    ...
    <div className="flex flex-col gap-16 py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <motion.div 
          ...
          className="group glass-panel-heavy p-8 rounded-[3rem] border-white/5 bg-white/[0.01] hover:bg-white/[0.03] transition-all flex flex-col gap-6 cursor-pointer"
        >
        ...
        <motion.div 
          initial={{ opacity: 0, x: 20 }}
          animate={{ opacity: 1, x: 0 }}
          className="group glass-panel-heavy p-8 rounded-[3rem] border-primary/20 bg-primary/[0.02] hover:bg-primary/[0.04] transition-all flex flex-col gap-6 cursor-pointer"
        >
          <div className="w-14 h-14 rounded-2xl bg-primary text-black flex items-center justify-center shadow-[0_0_20px_rgba(57,255,20,0.3)]">
            <Rocket size={28} />
          </div>
          <div className="space-y-2">
           ...
           <div className="absolute inset-0 pointer-events-none">
              {promptSuggestions.map((text, i) => (
                <motion.div
                  ...
                  className={cn(
                    "absolute whitespace-nowrap px-4 py-2 rounded-full border border-white/5 bg-black/40 backdrop-blur-md text-[9px] font-black text-zinc-400 uppercase tracking-widest",
